...
```{r include = TRUE, results = 'hide', eval = TRUE, warning = FALSE, message = FALSE}
...
```{r include = TRUE, results = 'hide', eval = TRUE}
...
![AFRF_ALPHA_HISTOGRAMS](images/afrf_alpha_histograms.png)
...
![AFRF_ALPHA_SPATIAL_ztrans](images/ALPHA_ztrans.png)
...
![AFRF_ALPHA_SPATIAL_all_trans](images/alpha_all_trans.png)
...
![afrf_alpha_quick_2d_plot](images/afrf_quick_2d_plot.png)
...
![afrf_alpha_residuals_spatial](images/afrf_alpha_Zresidual.png)
