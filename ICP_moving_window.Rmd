...
* **Moving_Window_ICP(i)** - This function performs the moving window operation and checks for extent matches between the two clipped point clouds at each window and decides whether or not to use the Run_ICP() function
```r
